# 🔬 Épididyme, Glandes Annexes & Liquide Séminal
...
> 💡 **Spermatozoïdes dans les tubes séminifères = NON FÉCONDANTS** → maturité acquise dans l'**épididyme** + complétée dans les **voies génitales féminines**
💡 **Plasma séminal** = Vésicules séminales **60%** + Prostate **30%** + Testiculaire/Épididymaire **10%** (= 8% épididyme + liquide testiculaire)
💡 **Marqueur des vésicules séminales = FRUCTOSE** · **Marqueur de l'épididyme = Carnitine + α-glycosidase** · **Marqueur de la prostate = Zinc + PAP (PSA)** · **Marqueur testiculaire = Transferrine**
💡 **Seules les vésicules séminales produisent du FRUCTOSE**
💡 **Vésicules séminales = pH alcalin (7,5–8)** · **Prostate = pH acide (6,5–7)** → ensemble = pH neutre du plasma séminal
💡 **Épididyme = 5 m** chez l'homme (bélier = 60 m) · Épithélium **pseudostratifié** avec cellules principales (stéréocils) + cellules basales
💡 **Zone périphérique prostate = 70% du tissu glandulaire** → zone des **cancers (70%)** et des **prostatites** → seule zone palpable au toucher rectal
💡 **Zone de transition prostate = 5%** du tissu glandulaire → siège **exclusif** des **hyperplasies bénignes** + 20% des cancers
💡 **PSA + PAP (phosphatases acides prostatiques)** → enzymes de **liquéfaction** du sperme → sécrétion prostatique
💡 **Séménogéline** (vésicules séminales) → coagulation du sperme au col vaginal → indispensable à la progression des spz
💡 **Fonctionnement glandes annexes + épididyme = androgéno-dépendant** → déficit en testostérone → volume d'éjaculat en-dessous de la norme
> 
...
- **1) Structure et localisation**
    ...
    **Localisation :** Postéro-supérieure au testicule
    
    **Composition :**
    
    - **Canal épididymaire** : grande surface d'échange entre cellules épididymaires et spermatozoïdes
    - ***Tête de l’épididyme.*** : reçoit les cônes / canaux efférents
    
    **Circuit en amont de l'épididyme :**
    
    ```
    Tubes séminifères
          ↓
    Tubes droits → Massif de TC dense (pauvre en fibres, riche en collagène)
          ↓
    Rete testis (épithélium CUBIQUE SIMPLE — lieu de PASSAGE uniquement, pas de modification morphologique)
          ↓
    Cônes efférents (épithélium PRISMATIQUE SIMPLE, cellules ciliées + lame basale + fibres musculaires lisses)
              → muqueuse + musculeuse
          ↓
    Tête de l'épididyme → Corps → Queue
          ↓
    Canal déférent → Canal éjaculateur → Carrefour vésiculo-déférentiel → Urètre prostatique
    ```
    
    **Taille :** **5 m** chez l'homme (variable selon les espèces : bélier = 60 m)
    
- **2) Histologie de la paroi épididymaire**
    
    La paroi comporte un épithélium reposant sur une **lame basale**, elle-même entourée d'une couche de **cellules musculaires lisses** (transport des spz)
    
    **Type d'épithélium : Pseudostratifié** ⭐
    
    | Type cellulaire | Caractéristiques |
    | --- | --- |
    | **Cellules principales** | Stéréocils au pôle apical (replis membranaires, **pas de vrais cils**) → ↑ surface d'échange entre cellules épididymaires et spermatozoïdes |
    | **Cellules basales** | Participent au **renouvellement** des cellules principales |
    
    **Gradient morphologique tête → queue :**
    
    | Niveau | Caractéristiques |
    | --- | --- |
    | **Tête + Corps** | Hauteur de l'épithélium **élevée** · Stéréocils +++ · Appareil de Golgi + vésicules +++ → **échanges actifs** |
    | **Queue** | Hauteur de l'épithélium **diminuée** · Stéréocils moins présents → rôle principalement de **stockage** des spermatozoïdes |
    
    > 🔑 La hauteur de l'épithélium **diminue** de la tête à la queue → les échanges s'effectuent principalement dans la **tête** et le **corps**
    > 

### B. Fonctions de l'Épididyme

- **Les 5 fonctions épididymaires**
    
    
    | Fonction | Détail |
    | --- | --- |
    | **Transport** | Les spz arrivent à la tête → progressent vers la queue en passant par le corps |
    | **Maturation** | Acquisition des **pouvoirs fécondants** : mobilité fléchante + aptitude à se fixer à la zone pellucide de l'ovocyte |
    | **Sécrétion** | Élaboration du **liquide épididymaire** |
    | **Stockage** | Au niveau de la **queue** de l'épididyme |
    | **Phagocytose** | Élimination des **spermatozoïdes morts ou anormaux** |
- **1) Fonction de sécrétion**
    
    L'épididyme produit des **protéines** et des **glycoprotéines** jouant un rôle dans :
    
    - La **fertilité** et le pouvoir fécondant des spz
    - La **fixation** à la zone pellucide
    - La **protection** des spz contre la réaction acrosomique ou la capacitation trop précoce *(ces 2 phénomènes doivent se passer dans le tractus féminin — si trop tôt = spz non utilisable)*
    
    Certaines protéines interviennent dans la **mobilité** du spz
    
    **Autres molécules sécrétées :**
    
    - **Ions** : potassium, phosphore…
    - **Petites molécules organiques** : inositol, carnitine…
    
- **2) Fonction d'absorption**
    - **Réabsorption du liquide épididymaire** (90% eau) jusqu'à la fin de la queue
    - Ce liquide est produit en grande quantité au niveau de la tête → réabsorbé progressivement au fur et à mesure de la progression des spz
    - → **Concentration des spermatozoïdes**
    - → **Absorption des protéines spécifiques par endocytose** :
        - ABP et transferrine (produites en amont) → réabsorbées
        - Réabsorption de la **testostérone** (plus nécessaire, pourrait être néfaste pour la femme)
        
- **3) Fonction métabolique**
    
    La réabsorption du liquide épididymaire stimule :
    
    | Processus métabolique | Détail |
    | --- | --- |
    | **Glycolyse** | Des cellules principales |
    | **Métabolisme des acides gras** | Voie de l'Acétyl-CoA |
    | **Conversion Testostérone → DHT** | Via la **5α-réductase** produite par les cellules épididymaires |
    
    **Rôles de la DHT produite localement :**
    
    - **Maturation épididymaire** des spermatozoïdes
    - **Maturation du conduit excréteur spermatique** → apparition des caractères sexuels secondaires à la puberté
    
    **Autres sécrétions métaboliques :**
    
    - **Prostaglandines** → action sur la contractilité du tractus génital féminin + métabolisme de la vitamine D
    
- **4) Contrôle des fonctions épididymaires**
    
    **Contrôle hormonal :**
    
    - Androgènes : **testostérone + DHT**
    - **ABP** (Androgen Binding Protein) : permet le transport de la testostérone
    - La **5α-réductase** locale → conversion testostérone → DHT → différenciation + acquisition de l'activité fonctionnelle de l'épididyme
    
    **Contrôle local :**
    
    - **ABP** agit en régulant directement l'activité des **cellules principales** de l'épididyme
    
- **5) Composition du liquide épididymaire**
    ...
    | **Eau** | +++ |
    | **Ions** | — |
    | **Protéines testiculaires** | Encore présentes (même si en partie éliminées) |
    | **Protéines épididymaires** | Celles pas encore insérées dans les spz |
    | **Enzymes** | — |
    | **Acide sialique** | — |
    | **Inositol** | — |
    | **Carnitine** | Source d'énergie |
    | **Androgènes** | En faible quantité |

### C. Maturation Épididymaire des Spermatozoïdes

**Vue d'ensemble des acquisitions**

| Acquisition | Description |
| --- | --- |
| **Modifications structurales, biochimiques et métaboliques** | Voir détail ci-dessous |
| **Mobilité fléchante** | Acquise au cours du transit épididymaire |
| **Fixation à la zone pellucide** et à la membrane cytoplasmique ovocytaire | Acquisition du pouvoir fécondant |
| **Aptitude à féconder l'ovocyte** | Dès le **corps** de l'épididyme chez l'homme |
| **Aptitude à assurer un développement embryonnaire normal** | — |
- **1) Modifications structurales, biochimiques et métaboliques**
    
    **A. Maturation nucléaire :**
    
    - Le **noyau du spermatozoïde** subit une maturation finale
    - Formation de **ponts disulfures** entre les cystéines des **protamines**
    - → **Condensation de la chromatine** ⭐
    
    **B. Maturation des enzymes acrosomiques :**
    
    - La **pro-acrosine** mature en **acrosine**
    
    **C. Modifications du cytoplasme :**
    
    | Modification | Détail |
    | --- | --- |
    | **Disparition des gouttelettes cytoplasmiques** | Au niveau de la pièce intermédiaire |
    | **Modification de la composition lipidique membranaire** | **↑ stérols** au profit des **phospholipides** → ↑ **stabilité membranaire** · Protection des spz lors du transit génital masculin et féminin |
    
    > ⚠️ Lors de la **capacitation** (dans le tractus féminin), les **stérols seront retirés** → ↑ mobilité du spz + ↑ fluidité membranaire
    ⚠️ Si la capacitation ou la réaction acrosomique se produit **trop tôt** (dans le tractus masculin) → **spz non utilisable**
    > 
    
- **2) Acquisition de la mobilité fléchante**
    
    **Mécanismes moléculaires de l'acquisition de la mobilité :**
    
    | Mécanisme | Direction |
    | --- | --- |
    | **↑ AMPc intracellulaire** (ATP-dépendant) | ↑ |
    | **↓ Calcium intracellulaire** | ↓ |
    | **↑ pH intracellulaire** | ↑ |
    
    Avec utilisation de la **carnitine** et de l'**acétyl-carnitine** comme substrats énergétiques
    
    **Les fibres denses et les gaines fibreuses sont stabilisées par des ponts disulfures**
    
    **Gradient de mobilité tête → queue :**
    
    | Niveau | Mobilité observée |
    | --- | --- |
    | **Tête de l'épididyme** | Spz **immobiles** dans leur milieu natif · Après dilution : mouvement détectable |
    | **Progression vers la queue** | Mobilité **↑** · Trajectoire **circulaire** · Mouvement **non progressif** (anarchique) |
    | **Queue de l'épididyme** | Mobilité **accrue** · Mouvement **progressif et linéaire** ⭐ |
- **3) Aptitude à se fixer sur la zone pellucide et la membrane ovocytaire**
    - **Modification de la composition des protéines membranaires** → résistance + stabilité → acquisition du pouvoir fécondant
    - Les protéines de la spermiogenèse d'origine testiculaire sont **modifiées / conservées** et d'autres sont **ajoutées** (résidus glycosylés)
    - **Modification de la charge électrique** du spermatozoïde
    
- **4) Perturbations de la maturation épididymaire — Conséquences cliniques**
    
    **Facteurs perturbateurs :**
    
    - Déficit en androgènes
    - Tabac, cannabis
    - Exposition professionnelle à des produits chimiques ou à la chaleur
    - **Perturbateurs endocriniens**
    - IST
    
    **Conséquence : stress oxydant biochimique** → altération des spz stockés dans la queue :
    
    - **Cassures d'ADN**
    - **Mauvaise condensation de l'ADN**
    - Absence des ponts disulfures entre les protamines
    - Histones restant intercalées dans les brins d'ADN (au lieu des protamines)
    
    **Application clinique :**
    
    > 🔑 Si ADN très fragmenté ou mal condensé → proposition de **biopsies testiculaires** pour récupérer des spz "tout frais" moins exposés aux perturbateurs endocriniens et environnementaux
    > 
...
- **Généralités et proportions**

Les glandes annexes élaborent les **3/4 du volume du plasma séminal** d'un éjaculat (le reste provient de l'épididyme)

| Glande | Proportion du plasma séminal | Marqueur de dosage |
| --- | --- | --- |
| **Vésicules séminales** (×2) | **60%** | **Fructose** |
| **Prostate** (×1) | **30%** | **Zinc + PAP (PSA)** |
| **Épididyme + Testicule** | **10%** (épididyme = 8%) | **Carnitine + α-glycosidase** (épididyme) · **Transferrine** (testicule) |

> ⚠️ Fonctionnement des glandes annexes = **androgéno-dépendant** : déficit en testostérone → glandes sous-développées → volume d'éjaculat **en-dessous de la norme**
> 

**Localisation anatomique :**

```
Testicule → Épididyme → Canal déférent → Ampoule déférentielle
                                                ↓
Vésicule séminale ──→ Carrefour vésiculo-déférentiel → Canal éjaculateur (dans la prostate)
                                                                    ↓
                                                          Urètre prostatique
```
...
- **1) Anatomie et histologie**
    ...
    **Localisation :** Au-dessus de la prostate (supra-prostatiques, rétro-vésicales)
    **Structure :** 2 organes **pairs**, en forme de sac, à **surface bosselée**, entourés d'une **capsule conjonctive** contenant un long tube pelotonné
    
    > ⚠️ **Non palpables** à l'examen clinique (même au toucher rectal) → visibles uniquement en **échographie endorectale**
    > 
    
    **Structure de la paroi (de dedans vers dehors) :**
    
    | Couche | Composition |
    | --- | --- |
    | **Muqueuse** | Épithélium **prismatique simple** (cellules prismatiques + cellules basales) |
    | **Chorion** | Tissu conjonctif **lâche** |
    | **Musculeuse** | Quelques fibres musculaires lisses → relargage du liquide séminal |
    | **Adventice** | Tissu conjonctif + **ganglions végétatifs** |
    
    **En ME — Cellules prismatiques (glandulaires) :**
    
    - Plus hautes que larges
    - **RE granuleux abondant et basal ++**
    - **Appareil de Golgi important**
    - **Grains de sécrétion apicaux**
    - **Enclaves lipidiques basales**
    
    > 🔑 Les vésicules séminales sont des **glandes exocrines** → synthétisent des composants du liquide séminal
    > 
    
- **2) Fonctions des vésicules séminales**
    - ✅ **Réabsorption** du liquide séminal (composants élaborés par elles-mêmes et par les glandes précédentes)
    - ✅ **Spermatophagie** = phagocytose des spermatozoïdes morts *(difficile de retrouver des spz dans la lumière des vésicules)*
    - ✅ **Sécrétion androgéno-dépendante**
    
- **3) Sécrétions des vésicules séminales**
    
    **Volume :** **60% du plasma séminal** · **pH alcalin = 7,5–8**
    
    | Molécule sécrétée | Rôle |
    | --- | --- |
    | **Fructose** ⭐ | **Seules les vésicules séminales** produisent du fructose → dosé en clinique pour évaluer leur fonctionnement |
    | **Potassium** | Joue sur la **mobilité des spz** |
    | **Acides aminés** | — |
    | **Prostaglandines** | Contraction tractus génital féminin + immunosuppression |
    | **Phospholipides** | — |
    | **Séménogéline** ⭐ | **Coagulation du sperme** au niveau du col vaginal → sans elle, les spz n'arrivent pas à s'échapper du liquide séminal pour entrer dans le col |
    | **Fibronectine** ⭐ | **Stabilisation** du coagulum séminal puis **dégradation** du coagulum |
    | **Protéines de transport et de structure** | — |
    | **Protéines modulatrices des fonctions immunitaires** | **Immunosuppression** dans le tractus génital féminin → les cellules immunitaires de la femme ne reconnaissent pas immédiatement les spz → protection contre la dégradation rapide |
    
    **Effets combinés des sécrétions :**
    
    - Formation du **coagulum** séminal
    - **Modification de la mobilité** des spermatozoïdes
    - **Immunosuppression** dans le tractus génital féminin
    
    > 💡 **En clinique :** On dose le **fructose** pour vérifier le bon fonctionnement des vésicules séminales (analyse de la biochimie séminale pour objectiver obstructions et déficits des glandes annexes)
    ⚠️ Exemple : Absence de vésicules séminales → absence de spz + réduction du volume + **pH acide** (plus de tampon alcalin)
    > 
...
- **1) Anatomie générale**
    ...
    **Caractéristiques :**
    ...
    - Organe **impair, médian, musculo-glandulaire**
    - Située en-dessous de la **vessie**
    - Forme le **carrefour des voies uro-génitales**
    - Volume : **15–20 cc** chez l'adulte
    
    **Structure interne :**
    
    - **Noyau fibro-musculaire central**
    - **Masse glandulaire périphérique**
    - **Capsule fibro-élastique** autour de la masse glandulaire → donne des **cloisons** délimitant des **lobules**
    
- **2) Anatomie zonale — Le territoire glandulaire**
    
    La prostate possède **4 zones** :
    
    | Zone | Localisation | % du tissu glandulaire | Pathologies |
    | --- | --- | --- | --- |
    | **Zone périphérique** | Postéro-latérale et inférieure · L'apex est entièrement formé par cette zone | **70%** | **70% des cancers** de la prostate + **prostatites** · Seule zone palpable au **toucher rectal** |
    | **Zone centrale** | Masse conique médiane postérieure · Traversée par les **2 canaux éjaculateurs** | **25%** | Très peu de cancers (10%) |
    | **Zone de transition** | Antéro-médiane · 2 lobes de part et d'autre de l'urètre prostatique | **5%** | Siège **exclusif** des **hyperplasies bénignes** (HBP) → problèmes de miction / rétentions · **20% des cancers** |
    | **Zone des glandes péri-urétrales** | Autour du lobe médian, paroi musculaire lisse de l'urètre | — | — |
    - Icon
        
        ![image.png](%F0%9F%94%AC%20%C3%89pididyme,%20Glandes%20Annexes%20&%20Liquide%20S%C3%A9minal/image.png)
        
    
    **Compartiments prostatiques :**
    
    | Compartiment | Zones incluses |
    | --- | --- |
    | **Compartiment externe** | Zone périphérique + Zone centrale |
    | **Compartiment interne** | Zone de transition + Glandes péri-urétrales |
- **3) Le territoire non-glandulaire**
    
    
    | Structure | Description |
    | --- | --- |
    | **Capsule prostatique** | Pseudo-capsule : couche interne **musculaire lisse** + couche externe en **collagène** |
    | **Stroma fibro-musculaire antérieur** | Épaississement antérieur de la capsule · **30% du volume prostatique** · Uniquement du stroma (aucune glande) |
    | **Canaux éjaculateurs** | Traversent la prostate |
    | **Urètre prostatique** | Traverse la prostate de haut en bas |
    | **Utricule prostatique** | Structure diverticulée · Dérivée des **canaux de Müller** · Quelques mm de hauteur · S'abouche dans l'urètre **entre** les canaux éjaculateurs |
- **4) Histologie prostatique**
    
    **Tissu glandulaire :** Acini et calots → sécrétions pouvant se stocker en amas = **corps amylacés** (= sympexions ou corps de Robin, formés par accumulation de glycoprotéines → peuvent se calcifier, visibles en coupe histologique / radio / écho · De plus en plus nombreux avec l'âge)
    
    **Épithélium glandulaire :** Assises de cellules **cubiques ou prismatiques** reposant sur une **lame basale** · Cellules relevées en festons · Quelques cellules basales de remplacement
    
    **3 groupes histologiques des glandes (plan histologique) :**
    
    | Groupe | Localisation | Importance |
    | --- | --- | --- |
    | **Muqueux** | Péri-urétral interne (le plus proche de l'urètre) | — |
    | **Sous-muqueux** | Péri-urétrales moyennes (intermédiaire) | — |
    | **Glandes principales (groupe externe)** | Périphérique | Origine de la **grande majorité** des sécrétions prostatiques |
    
    > ⚠️ Le **stroma** est abondant : fibres conjonctives + élastiques → forme des cloisons autour des lobules
    💡 Cours : pas de questions sur les groupes histologiques
    > 
    
    **Tissu non-glandulaire :** Stroma conjonctif mêlé d'éléments **musculaires lisses**
    
- **5) Fonctions de la prostate**
    
    **Volume sécrété :** **30% du plasma séminal** · **pH acide = 6,5–7** · Sécrétions **androgéno-dépendantes**
    
    > 🔑 Le pH acide de la prostate **tamponne** les sécrétions basiques des vésicules séminales → plasma séminal de **pH neutre**
    > 
    
    | Sécrétion prostatique | Rôle |
    | --- | --- |
    | **PSA** (Antigène spécifique de prostate) | Enzyme de **liquéfaction** du sperme après l'éjaculation |
    | **PAP** (Phosphatases acides prostatiques) | Enzyme de **liquéfaction** du sperme · Dosée en clinique comme marqueur prostatique |
    | **Protéases** | Enzymes de liquéfaction du sperme |
    | **Spermine** (polyamine) | Contrôle de la **mobilité** des spz · **Inhibition de la capacitation spontanée** dans le liquide séminal |
    | **Cadavérine** (polyamine) | Responsable de l'**odeur caractéristique** du liquide séminal |
    | **Protéines immunosuppressives** | Évitent la phagocytose des spz dans le tractus génital féminin (cellules étrangères) |
    | **Cholestérol** | — |
    | **Ions** : sodium, potassium, calcium | — |
    | **Zinc** ⭐ | Dosé en clinique pour évaluer la production prostatique |
    
    > 💡 **En clinique :** Dosage du **zinc** pour évaluer la production de la prostate · Dosage du **PSA** pour le dépistage du cancer de la prostate
    > 

---

## III. Le Plasma Séminal

### A. Composition et Marqueurs

- **Tableau récapitulatif — À connaître par cœur**
    
    
    | Origine | % du plasma séminal | Marqueur de dosage clinique |
    | --- | --- | --- |
    | **Vésicules séminales** | **60%** | **Fructose** |
    | **Prostate** | **30%** | **Zinc + PAP (phosphatases acides prostatiques)** |
    | **Épididyme** | **~8%** | **Carnitine + α-glycosidase** |
    | **Liquide testiculaire** | Reste (~2%) | **Transferrine** |
    
    > 🔑 L'analyse de la **biochimie séminale** permet d'objectiver des **obstructions** et des **déficits des glandes annexes** lors d'un **spermogramme** (recueil après éjaculation, utilisé pour le diagnostic d'infertilité masculine)
    > 

### B. Rôles du Plasma Séminal

- **Rôles mécaniques et protecteurs**
    
    
    | Rôle | Mécanisme |
    | --- | --- |
    | **Stabilisation de la membrane spermatique** | Facteurs de décapacitation + inhibiteurs de la capacitation spontanée |
    | **Favorise la mobilité des spz** | Potassium (vésicules séminales), spermine (prostate) |
    | **Condensation nucléaire** | Ajout de **zinc** entre les ponts disulfures posés pendant le transit épididymaire → condense et protège encore plus l'ADN des spz |
- **Rôles dans les voies génitales féminines**
    
    
    | Rôle | Mécanisme |
    | --- | --- |
    | **Activation du tractus génital féminin** | **Prostaglandines** |
    | **Inhibition des réactions immunitaires** | **Prostaglandines** + protéines immunosuppressives (vésicules séminales + prostate) |
    | **Coagulation + liquéfaction du sperme** | Séménogéline + Fibronectine (coagulation) → PSA + PAP + Protéases prostatiques (liquéfaction secondaire) |

---

## IV. Schéma Récapitulatif — Circuit Spermatique + Contributions Glandulaires

```jsx
TESTICULE (tubes séminifères)
  Spz non fécondants
       ↓ Tubes droits → Rete testis → Cônes efférents
ÉPIDIDYME (5 m chez l'homme)
  Tête : échanges actifs (stéréocils +++ / Golgi +++)
  Corps : maturation progressive
  Queue : stockage + mobilité progressive linéaire
       ↓ Acquisition : mobilité fléchante + fixation ZP + pouvoir fécondant
       ↓ Liquide épididymaire (~8% plasma séminal)
  Marqueurs : Carnitine + α-glycosidase
CANAL DÉFÉRENT → AMPOULE DÉFÉRENTIELLE
       ↓
CARREFOUR VÉSICULO-DÉFÉRENTIEL
  Vésicules séminales (60% plasma séminal)
  pH alcalin 7,5–8 · Fructose (marqueur) · Séménogéline · Fibronectine
  Immunosuppression · Coagulation du sperme
       ↓
CANAL ÉJACULATEUR (dans la prostate)
       ↓
PROSTATE (30% plasma séminal)
  pH acide 6,5–7 · Zinc (marqueur) · PAP · PSA · Spermine · Cadavérine
  Liquéfaction du sperme · Immunosuppression
       ↓
URÈTRE PROSTATIQUE → GLANDES BULBO-URÉTRALES → URÈTRE
       ↓
ÉJACULAT = PLASMA SÉMINAL (pH neutre) + SPERMATOZOÏDES
```

---

## V. Pièges et Points Clés d'Examen +++

> ⚠️ **Spz dans les tubes séminifères = NON FÉCONDANTS** — la maturation commence dans l'épididyme et se termine dans les voies génitales **féminines** (capacitation + réaction acrosomique)
> 

> ⚠️ **Épithélium de l'épididyme = PSEUDOSTRATIFIÉ** (≠ stratifié) · Cellules principales avec **stéréocils** (replis membranaires, pas de vrais cils)
> 

> ⚠️ **Rete testis = épithélium CUBIQUE SIMPLE** = lieu de **passage uniquement** (aucune modification morphologique des spz)
> 

> ⚠️ **Cônes efférents = épithélium PRISMATIQUE SIMPLE** (cellules ciliées + lame basale + fibres musculaires lisses)
> 

> ⚠️ **FRUCTOSE = marqueur EXCLUSIF des vésicules séminales** — aucune autre glande n'en produit
> 

> ⚠️ **Vésicules séminales = pH 7,5–8 (alcalin)** · **Prostate = pH 6,5–7 (acide)** → plasma séminal final = **pH neutre** par tamponnage réciproque
> 

> ⚠️ **Zone périphérique = 70%** du tissu glandulaire → 70% des cancers + prostatites · **Seule zone palpable** au toucher rectal
> 

> ⚠️ **Zone de transition = 5%** du tissu glandulaire → siège **EXCLUSIF** des HBP + 20% des cancers
> 

> ⚠️ **Utricule prostatique** = dérivé des **canaux de Müller** (vestige)
> 

> ⚠️ **Stroma fibro-musculaire antérieur** = 30% du volume prostatique = **pur stroma**, aucune glande
> 

> ⚠️ **Mobilité à la queue de l'épididyme = progressive et LINÉAIRE** (≠ circulaire dans le corps, ≠ absente dans la tête)
> 

> ⚠️ **Acquisition de la mobilité = ↑ AMPc + ↓ Ca²⁺ + ↑ pH intracellulaire** + carnitine/acétyl-carnitine
> 

> ⚠️ **Capacitation et réaction acrosomique = TRACTUS FÉMININ** uniquement — si trop précoce = spz inutilisable
> 

> ⚠️ **Spermine** (prostate) = inhibe la **capacitation spontanée** dans le liquide séminal (protection avant le tractus féminin) + rôle dans la mobilité
> 

> ⚠️ **Cadavérine** (prostate) = responsable de l'**odeur** du liquide séminal
> 

> ⚠️ **Séménogéline** (vésicules séminales) = coagulation du sperme au col vaginal → INDISPENSABLE pour que les spz s'en échappent
> 

> ⚠️ **PSA + PAP** = enzymes de **liquéfaction SECONDAIRE** du sperme après l'éjaculation (prostate)
> 

> ⚠️ **DHT dans l'épididyme** = produite par la **5α-réductase** épididymaire (conversion locale de la testostérone) → maturation épididymaire + maturation du conduit excréteur → caractères sexuels secondaires
> 

> ⚠️ **ADN fragmenté ou mal condensé** dans l'épididyme (stress oxydant) → proposition de **biopsies testiculaires** (spz testiculaires moins exposés)
> 

> ⚠️ **Zinc** = dosé pour évaluer la **prostate** · **Carnitine + α-glycosidase** = marqueurs **épididymaires** · **Transferrine** = marqueur **testiculaire**
>